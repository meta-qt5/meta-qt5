...
LICENSE = "Apache-2.0 AND BSD-3-Clause AND BSL-1.0 AND GFDL-1.3-only AND MIT AND OpenSSL AND (GPL-3.0-only AND LicenseRef-The-Qt-Company-GPL-Exception-1.0 OR LicenseRef-The-Qt-Company-Commercial) AND (GPL-2.0-or-later OR LGPL-3.0-only OR LicenseRef-The-Qt-Company-Commercial)"
LIC_FILES_CHKSUM = " \
