...
LICENSE = "BSD-3-Clause AND GFDL-1.3-no-invariants-only AND LGPL-3.0-only OR GPL-3.0-only OR LicenseRef-The-Qt-Company-Commercial"
LIC_FILES_CHKSUM = " \
...
SRCREV = "3e790bf29afbc46ee6093685f26fb80474c5268d"
