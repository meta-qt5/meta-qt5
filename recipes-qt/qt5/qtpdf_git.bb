...
LICENSE = "BSD-3-Clause AND (GPL-3.0-only AND LicenseRef-The-Qt-Company-GPL-Exception-1.0 OR LicenseRef-The-Qt-Company-Commercial) AND (LGPL-3.0-only OR LicenseRef-The-Qt-Company-Commercial)"
LIC_FILES_CHKSUM = " \
