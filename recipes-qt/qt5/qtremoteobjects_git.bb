LICENSE = "BSD-3-Clause AND GPL-3.0-only AND LicenseRef-The-Qt-Company-GPL-Exception-1.0 AND (GPL-2.0-or-later OR LGPL-3.0-only) OR LicenseRef-The-Qt-Company-Commercial"
LIC_FILES_CHKSUM = " \
